...
<head>
    ...
    <title>Fujairah | Space Terminal</title>
...
<body>
    ...
    <section class="relative bg-cover bg-center h-[500px]" style="background-image: url('assets/images/hero-bg.jpg');">
        ...
        <div class="relative max-w-7xl mx-auto h-full flex flex-col justify-center items-center text-center px-6">
            <!-- Hero Content -->
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-4">Terminals in Fujairah </h2>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-white rounded-xl overflow-hidden">

                <!-- Image -->
                <div class="h-full">
                    <img src="assets/images/Fujairah_img.jpg" alt="Fujairah Terminal"
                        class="w-full h-full object-cover" />
                </div>

                <!-- Content -->
                <div class="p-8 md:p-10">
                    <h2 class="text-3xl md:text-4xl md:text-3xl font-bold text-gray-800 mb-4 uppercase">
                        Terminals in Fujairah
                    </h2>

                    <p class="text-gray-600 mb-4 leading-relaxed">
                        Space Terminal Services delivers world-class storage and transportation solutions for petroleum
                        and petrochemical products. Our Fujairah Terminal is strategically positioned within a global
                        energy hub, offering seamless access to major trade routes.
                    </p>

                    <p class="text-gray-600 mb-4 leading-relaxed">
                        With over <span class="font-semibold text-gray-800">2,000,000 tons</span> of storage capacity
                        and advanced multi-purpose distillation units, the terminal efficiently handles parcel sizes
                        from 1,000 to 500,000 tons while maintaining the highest international safety standards.
                    </p>

                    <p class="text-gray-600 leading-relaxed mb-6">
                        A fully equipped on-site laboratory ensures product integrity, precision handling, and
                        operational excellence across all loading and unloading activities.
                    </p>

                    <!-- CTA -->
                    <a href="../Contact Us/index.html"
                        class="inline-block bg-[#0d314d] hover:bg-[#13406b] text-white font-semibold px-6 py-3 rounded-lg transition duration-300">
                        Contact Us
                    </a>
                </div>
            ...
            <div class="overflow-x-auto bg-white shadow rounded-lg">
                <table class="min-w-[1100px] w-full text-sm border-collapse">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">Rotterdam - LNG Terminal Fujirah</td>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">Rotterdam - Southern LLC Rotterdam - Fujirah Terminal</td>
                            <td class="px-4 py-2">100.00%</td>
                            <td class="px-4 py-2">150,150</td>
                            <td class="px-4 py-2">-</td>
                            <td class="px-4 py-2">C</td>
                            <td class="px-4 py-2">G</td>
                            <td class="px-4 py-2">V</td>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">Rotterdam - Southern LLC Rotterdam - Coatzacoalcos Terminal</td>
                            <td class="px-4 py-2">100.00%</td>
                            <td class="px-4 py-2">25,900</td>
                            <td class="px-4 py-2">-</td>
                            <td class="px-4 py-2">C</td>
                            <td class="px-4 py-2">G</td>
                            <td class="px-4 py-2">V</td>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">Rotterdam - Southern LLC Rotterdam - Veracruz Terminal</td>
                            <td class="px-4 py-2">100.00%</td>
                            <td class="px-4 py-2">213,100</td>
                            <td class="px-4 py-2">-</td>
                            <td class="px-4 py-2">C</td>
                            <td class="px-4 py-2">-</td>
                            <td class="px-4 py-2">V</td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">100.00%</td>
                            <td class="px-4 py-2">1,282,512</td>
                            <td class="px-4 py-2">P</td>
                            <td class="px-4 py-2">C</td>
                            <td class="px-4 py-2">-</td>
                            <td class="px-4 py-2">-</td>
